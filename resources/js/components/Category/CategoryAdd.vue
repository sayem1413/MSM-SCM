                    ...
                    <div class="card bg-light">
                        <div class="card-header bg-transparent">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <h5 class="float-left">Category Add</h5>
                                </div>
                                <div class="col-md-8 col-sm-8">
                                    <ul class="nav nav-tabs float-right">
                                        <li class="nav-item">
                                            <router-link :to="{name:'category_list'}" class="nav-link text-light bg-info font-weight-bold">List</router-link>
                                        </li>
                                        <li class="nav-item">
                                            <router-link :to="{name:'category_add'}" class="nav-link text-light bg-info active font-weight-bold">Add New</router-link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="post" >
                                ...
                                <div class="form-group col-md-10 col-sm-10">
                                    <button class="btn btn-secondary" type="button" @click.prevent="addCategory(0)">Save and back to List</button>
                                    <button class="btn btn-secondary" type="button" @click.prevent="addCategory(1)">Save and continue Edit</button>
                                </div>
                            </form>
                        </div>
                    </div>
