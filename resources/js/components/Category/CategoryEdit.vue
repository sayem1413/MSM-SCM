                        ...
                        <div class="card-header bg-transparent">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <h5 class="float-left">Category Edit</h5>
                                </div>
                            ...
                            <div>
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group col-md-10 col-sm-10">
                                        ...
                                        <button class="btn btn-secondary" type="button" @click.prevent="updateCategory(0)">Update and back to List</button>
                                        <button class="btn btn-secondary" type="button" @click.prevent="updateCategory(1)">Update and continue Edit</button>
                                    </div>
                                </form>
                            </div>
