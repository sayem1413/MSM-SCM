<template>
    <draggable :element="'ul'" :list="categories_data" class="list-group border-0" :options="draggableOptions" v-on:change="updateParentCategory">
...
import ChildCategoryTree from './ChildCategoryTree';
import draggable from 'vuedraggable';
export default {
    name: "parent-category-tree",
    components: {
        CategoryDelete,
        draggable,
        ChildCategoryTree,
    },
    props: ['categories_data', 'allCategories'],
    data: function() {
        return {
            draggableOptions:{
                group:{ name:'g1'},
    ...
    methods:{
        ...
        updateParentCategory(e){
            let url = ROOT_URL+"update-parent-category";
            ...
            let parentCategories = {
                parentCategories: this.categories_data,
            }
            
            axios.post(url, parentCategories).then((response) => {
