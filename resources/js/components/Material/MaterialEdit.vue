                        ...
                        <div class="card-header bg-transparent">
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <span class="font-weight-bold">Gen. Material Class Edit</span>
                                </div>
                                <div class="col-md-6 col-sm-6">
                            ...
                            <div>
                                <form class="form-horizontal" method="post" >
                                    ...
                                    <div class="form-group col-md-12 col-sm-12">
                                        ...
                                        <button class="btn btn-secondary btn-lg btn-sm" type="button" @click.prevent="updateMaterial(0)">Update & List</button>
                                        <button class="btn btn-secondary btn-lg btn-sm" type="button" @click.prevent="updateMaterial(1)">Update</button>
                                    </div>
                                </form>
                            </div>
...
export default {
    ...
    methods: {
        materialInfo(lang){
            ...
            axios.get(url + this.$route.params.materialId ).then((response)=>{
        ...
        updateMaterial( edit ) {
            ...
            formData.append("id", this.$route.params.materialId);
            formData.append("name", this.material.name);
            formData.append("description", this.material.description);
            formData.append("_method", 'PATCH');
            axios.post(url + this.$route.params.materialId, formData, {
                headers: {
