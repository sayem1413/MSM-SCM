                        ...
                        <div class="card-header bg-transparent">
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <span class="font-weight-bold">Color Add</span>
                                </div>
                                <div class="col-md-6 col-sm-6">
                            ...
                            <form class="form-horizontal" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <button class="btn btn-secondary btn-lg btn-sm" type="button" @click.prevent="addColor(0)">Save & List</button>
                                        <button class="btn btn-secondary btn-lg btn-sm" type="button" @click.prevent="addColor(1)">Save & Edit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
export default {
    ...
    methods: {
        addColor( edit ) {
            ...
            axios.post(url, newColor).then((response) => {
                if( edit == 1 ){
                    this.$router.push({ name: "color_edit", params:{ colorId:response.data.data.id } }) //("/color/edit/"+ response.data.data.id);
                } else {
